...
<template>
  <v-timeline side="end">
    ...
    <MobileTimelineItem v-bind="gymmbuddy"
    ...
    <MobileTimelineItem v-bind="resumeProcessor"
    ...
    <MobileTimelineItem v-bind="analysis"
    ...
    <MobileTimelineItem v-bind="database"
      >As part of our
      <a
